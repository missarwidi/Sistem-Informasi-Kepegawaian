                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
								...
								echo"<div class='clearfix'>
										  <div class='btn-group'><a href='?r=kategori&act=baru'>
						  ...
						  ?>
								...
								<?php
								    $no = 0;
									$qsurat = mysql_query("SELECT * FROM kategori ORDER BY id DESC");
									...
									echo"
                                      <tr class='gradeX'>
                                          <td>$no</td>
                                          <td>$rsurat[kategori]</td>
                                          <td class='center hidden-phone'>"; ?>
										  
										  <a href="<?php echo"$aksi?r=kategori&id=$rsurat[id]&act=hapus"; ?>" 
...
<?php case "baru": ?>
 ...
 <!--main content start-->
	  ...
	  ?>
	  <form action="<?php echo"$aksi?r=kategori&act=baru"; ?>" role="form" method="post" enctype="multipart/form-data" 
