                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              Management Alasan Barang Keluar
                          </header>
                          <div class="panel-body">
								...
								echo"<div class='clearfix'>
										  <div class='btn-group'><a href='?r=alasan&act=baru'>
						  ...
						  ?>
								...
								<?php
								    $no = 0;
									$qsurat = mysql_query("SELECT * FROM alasan ORDER BY id DESC");
									...
									echo"
                                      <tr class='gradeX'>
										  ...
										  <a href="<?php echo"$aksi?r=alasan&id=$rsurat[id]&act=hapus"; ?>" 
...
<?php case "baru": ?>
 ...
 <!--main content start-->
	  ...
	  ?>
	  <form action="<?php echo"$aksi?r=alasan&act=baru"; ?>" role="form" method="post" enctype="multipart/form-data" 
                          ...
                          <div class="panel-body">
                              <div class="form-horizontal">
							     <div class="form-group">
                                      <label  class="col-lg-3 col-sm-3 control-label">Alasan Barang Keluar</label>
                                      <div class="col-lg-9">
                                          <div class="iconic-input">
                                              <i class="fa fa-book"></i>
                                              <input type="text" class="form-control" placeholder="Alasan Barang Keluar" name="alasan">
                                          </div>
                                      </div>
                                  </div>                           
                              </div>
