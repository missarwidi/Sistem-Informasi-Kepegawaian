                                  ...
                                  <ul id="sortable" class="task-list">
                                      ...
                                      <li class="list-danger">
                                          ...
                                          <div class="task-title">
											  ...
											  <a href="<?php echo"word/berita_acara_penelitian.php?surat=$nomor_surat&id=$id"; ?>" target="_blank">
                                                  <button class="btn btn-info btn-xs fa fa-angle-double-down"> Download Word</button></a>
                                              </div>
                                          </div>
                                      </li>
                                          ...
                                          <div class="task-title">
                                              ...
                                              <div class="pull-right hidden-phone">
											   ...
											   <a href="<?php echo"pdf/lampiran_berita_acara.php?surat=$nomor_surat&id=$id"; ?>" target="_blank">
                                                  <button class="btn btn-danger btn-xs fa fa-angle-double-down"> Download PDF</button></a>
											   <a href="<?php echo"word/lampiran_berita_acara.php?surat=$nomor_surat&id=$id"; ?>" target="_blank">
                                                  <button class="btn btn-info btn-xs fa fa-angle-double-down"> Download Word</button></a>
                                              </div>
                                          </div>
                                      </li>
                                      <li class="list-warning">
                                          ...
                                          <div class="task-title">
											  ...
											  <a href="<?php echo"pdf/daftar_barang_bukti.php?surat=$nomor_surat&id=$id"; ?>" target="_blank">
                                                  <button class="btn btn-danger btn-xs fa fa-angle-double-down"> Download PDF</button></a>
											  <a href="<?php echo"word/daftar_barang_bukti.php?surat=$nomor_surat&id=$id"; ?>" target="_blank">
                                                  <button class="btn btn-info btn-xs fa fa-angle-double-down"> Download Word</button></a>
                                              </div>
                                          </div>
                                      </li>
                                  ...
                                  <ul id="sortable" class="task-list">
                                      <li class="list-primary">
                                          ...
                                          <div class="task-title">
                                            ...
                                            <button class="btn btn-danger btn-xs fa fa-angle-double-down"> Download PDF</button></a>
											<a href="<?php echo"word/berita_acara_penyerahan_pengembalian.php?surat=$nomor_surat&id=$id"; ?>" target="_blank">
                                            <button class="btn btn-info btn-xs fa fa-angle-double-down"> Download Word</button></a>
                                              </div>
                                          </div>
                                      </li>
