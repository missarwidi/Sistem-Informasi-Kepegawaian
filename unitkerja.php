				  ...
				  <!--breadcrumbs start -->
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
								...
								<?php
								  ...
								  { echo"
									  ...
									  <strong>Gagal Di Proses !</strong> Nip Unit Kerja Sudah Pernah Diinput.
									  </div>
								  "; }
								
								echo"<div class='clearfix'>
										  <div class='btn-group'><a href='?r=unitkerja&act=baru'>
						  ...
						  ?>			  								
								...
								<?php
								    $no = 0;
									$qpeg = mysql_query("SELECT * FROM unitkerja ORDER BY id DESC");
									...
									echo"
                                      <tr class='gradeX'>
                                          ...
                                          <td>$unitkerja</td>
                                          <td class='hidden-phone'><a href='?r=unitkerja&act=ubah&id=$id'>
										  <button class='btn btn-warning btn-xs'><i class='fa fa-edit'> Ubah</i></button>"; ?>
										 
										  <a href="<?php echo"$aksi?r=unitkerja&id=$idmd5&act=hapus"; ?>" 
...
<?php case "baru": ?>
 ...
 <!--main content start-->
	  ...
	  ?>
	  <form action="<?php echo"$aksi?r=unitkerja&act=baru"; ?>" role="form" method="post" enctype="multipart/form-data">
      <section id="main-content">
              ...
              <!-- page start-->
			   <div class="row">
				  ...
				  <!--breadcrumbs start -->
                      <ul class="breadcrumb">
                          <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
                          <li><a href="index.php?r=unitkerja">Data Unit Kerja</a></li>
                          ...
                          <div class="panel-body">
                              <div class="form-horizontal">			
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                              <input type="text" class="form-control" placeholder="unitkerja" name="unitkerja"
											  value="" required>
                                      </div>
                                  </div>								  
...
<?php case "ubah": ?>
 ...
 <!--main content start-->
	  ...
	  ?>
	  <?php			  
		$qpeg=mysql_query("SELECT * FROM unitkerja where id='$id' ORDER BY id DESC ");
          ...
          <section class="wrapper">
              <!-- page start-->
			   <div class="row">
				...
				</div><form action="<?php echo"$aksi?r=unitkerja&act=ubah"; ?>" role="form" method="post" enctype="multipart/form-data">
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
						  ...
						  ?>	
                                  <div class="form-group">
                                      <label  class="col-lg-2 col-sm-2 control-label">Unit Kerja</label>
                                      <div class="col-lg-6">
                                              <input type="hidden" class="form-control" name="idunitkerja"
											  value="<?php echo $rpeg['id']; ?>" required>
                                              <input type="text" class="form-control" placeholder="unitkerja" name="unitkerja"
											  value="<?php echo $rpeg['unitkerja']; ?>" required>
                                      </div>
                                  </div>
									...
									<div class="fileupload fileupload-new" data-provides="fileupload">
									  ...
									  <?php
										  if($gambar != ""){
											...
											echo "<img src='img/unitkerja/noimage.png' alt='' />";
										  }
										  ?>
									  </div>
									  </div>
